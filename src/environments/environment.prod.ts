...
export const environment = {
  ...
  tenantLogoUrl: loadedEnv['tenantLogoUrl'] || 'assets/images/access-bank-logo.png',
  tenantLogoUrlDark: loadedEnv['tenantLogoUrlDark'] || 'assets/images/access-bank-logo.png',
